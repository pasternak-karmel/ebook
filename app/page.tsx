    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="relative z-10 flex h-full items-center justify-center">
          <div className="text-center">
            ...
            <p className="mb-8 max-w-md mx-auto text-xl text-gray-300">
              Découvrez nos produits digitaux premium pour atteindre vos
              objectifs plus rapidement et plus efficacement.
            </p>
              ...
              {[
                {
                  ...
                  description:
                    "Boostez votre efficacité avec nos techniques éprouvées.",
                  price: "29.99€",
                  badge: "Bestseller",
                },
                {
                  ...
                  description:
                    "Maîtrisez l'art de la photographie numérique comme un pro.",
                  price: "49.99€",
                  badge: "Nouveau",
                },
                {
              ...
              {[
                {
                  ...
                  avatar: "S",
                  testimonial:
                    "Ces produits ont complètement transformé ma façon de travailler. Je suis beaucoup plus productive maintenant !",
                  rating: 5,
                },
                {
                  name: "Thomas M.",
                  avatar: "T",
                  testimonial:
                    "La qualité des contenus est exceptionnelle. Je recommande vivement à tous les entrepreneurs.",
                  rating: 5,
                },
                {
                  name: "Emma R.",
                  avatar: "E",
                  testimonial:
                    "Un excellent rapport qualité-prix. Ces outils m'ont fait gagner des heures de travail.",
                  rating: 4,
                },
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-primary-foreground/90 md:text-xl">
                  Rejoignez des milliers de clients satisfaits et commencez
                  votre voyage vers le succès dès aujourd&apos;hui.
                </p>
              </div>
              <Button
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2024 Acme Inc. Tous droits réservés.
        </p>
